...
import com.github.tamnguyenbbt.dom.SearchMethod;
...
public class DomUtilTest
{
    ...
    @Test
    public void immiTest() throws Exception
    {
        //Arrange
        String resourcePath = getClass().getClassLoader().getResource("immi.html").getFile();
        Document document = domUtil.htmlFileToDocument(resourcePath);

        //Act


        Element element1 =domUtil.getElementBestEffort(document,
                "Label",
                "Country of passport",
                "select");
        List<String> xpath1 =domUtil.getXpaths(document,
                "Label",
                "Country of passport",
                "select");

//        resourcePath = getClass().getClassLoader().getResource("google-signup.html").getFile();
//        document = domUtil.htmlFileToDocument(resourcePath);
//        Element element2  = domUtil.getElement(document, "div", "Username",
//                "input");

        Element element = domUtil.getElementWithTwoAnchorsBestEffort(
                document,
...
//        try
//        {
//            domUtil.getWebElement(driver, "invalid anchor", "input").sendKeys(String.format("%s@google.com", uuid));
//        }
